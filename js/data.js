...
window.CLASSES = [
    ...
    { name: "THE WATCHER", desc: "Once per turn, you may look at the top card of any player's Candle and choose to leave it on top or put it on the bottom. Counts as your action." },
    { name: "THE ACCUMULATOR", desc: "Hand Limit is 8 (instead of 5)." },
